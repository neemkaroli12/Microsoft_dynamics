"""
Django settings for my_microsoft project.
...
SECRET_KEY = 'django-insecure-8%o6^2k_cshrnr8wi^lm@$61g5#a7$l7hezo@7vkmqz-!9&2w9'
...
ROOT_URLCONF = 'my_microsoft.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'newapp.context_processors.courses_context',
            ],
        },
    },
]

WSGI_APPLICATION = 'my_microsoft.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'microsoft_dynamics_db',   # yahan apna db name
        'USER': 'dynamics_user',           # yahan user name
        'PASSWORD': 'dynamics#123',       # password (agar bhool gaye ho to naya set karenge)
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
# WhiteNoise storage for static files (essential for deployment)
